  ...
  customerStats: [
    {
      ...
      avatarIcon: 'bx-box',
      title: 'Order Status',
      successfullyDelivered: 12,
      partiallyDelivered: 8,
      notDelivered: 1,
    },
    {
      color: 'error',
      avatarIcon: 'bx-shield-x',
      title: 'Defaulters Status',
      chipLabel: 'Fake member',
      fakeShopifyOrders: 2,
      fakeManualOrders: 1,
    },
    {
      ...
      content: 'Orders by channel',
      shopifyOrders: 13,
      manualOrders: 8,
      description: 'More then 50% are manual orders'
    },
    {
      color: 'info',
      avatarIcon: 'bx-crown',
      ...
      device: 'Desktop',
      campaign: 'Campaign 1',
      description: 'Customer came by campaign strategy'
    },
    {
      color: 'secondary',
      avatarIcon: 'bx:shopping-bag',
      title: 'Purchased Category',
      purchasedCategory: 'Electronics',
      description: 'Customer likes to buy electronics'
    }
  ],
