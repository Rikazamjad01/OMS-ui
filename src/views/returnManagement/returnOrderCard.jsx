...
const ReturnOrderCard = ({ orderStats }) => {
  const isBelowMdScreen = useMediaQuery(theme => theme.breakpoints.down('md'))
  const isBelowSmScreen = useMediaQuery(theme => theme.breakpoints.down('sm'))

  // Map API response to stats array
  const statsData = [
    { key: 'total', title: 'Total Returned Orders', icon: 'bx-calendar' },
    { key: 'confirmed', title: 'Tried One Time Orders', icon: 'bx-check-double' },
    { key: 'processing', title: 'Tried Two Times Orders', icon: 'bx-hourglass' },
