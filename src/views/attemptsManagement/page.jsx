...
import AttemptsListTable from './attemptsListTable/AttemptsListTable'
import AttemptsCard from './attemptsCards/AttemptsCards'

// import OrderListTable from '@/views/apps/ecommerce/orders/list/OrderListTable'

const AttemptsManagementPage = () => {
  ...
  return (
    <Grid container spacing={6}>
      <Grid size={{ xs: 12 }}>
        <AttemptsCard orderStats={orderStats} />
      </Grid>
...
export default AttemptsManagementPage
