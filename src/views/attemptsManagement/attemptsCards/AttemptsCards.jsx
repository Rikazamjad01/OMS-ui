...
const AttemptsCards = ({ orderStats }) => {
  ...
  const statsData = [
    ...
    { key: 'confirmed', title: 'First Attempt Orders', icon: 'bx-check-double' },
    { key: 'processing', title: 'Second Attempt Orders', icon: 'bx-hourglass' },
  ].map(item => ({
    ...item,
